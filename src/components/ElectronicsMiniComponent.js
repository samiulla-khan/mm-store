...
function ElectronicsMiniComponent() {
    let data = electronicsData.sort(() => 0.5 - Math.random()).slice(0, 4)
    return (
                ...
                <section>
                    <div className="row">
                        <div className="col-10">
                            <h4 className="poppins-bold">Electronic's</h4>
                        </div>
                        <div className="col-2 d-flex align-items-center justify-content-end">
                            <Link to="/electronics" className="poppins-bold goto-arrow" style={{ textDecoration: 'none' }}>
                                &#8250;
                            </Link>
                        </div>
                    </div>
...
export default ElectronicsMiniComponent;